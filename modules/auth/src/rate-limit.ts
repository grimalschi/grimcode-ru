 ...
 * is not free, which is a per-module concern and belongs next to the check it protects. Volumetric
 * limits — requests per address, per network — belong at the edge proxy in front of Router, which
 * is the only thing that knows the real client address; see this module’s README.
 *
