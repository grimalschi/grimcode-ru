  ...
  return (
    <article className="prose-page mx-auto w-full max-w-2xl px-6 py-16">
      ...
      <p className="text-muted-foreground mt-2">
        Набор небольших модулей, которые уже работают вместе: публичный сайт, приложение за входом
        и админка с ролями и доступами.
      </p>

      <h2 className="mt-8 text-xl font-medium">Как устроено</h2>
      <p className="text-muted-foreground mt-2">
        Каждый модуль владеет своими данными и своим интерфейсом. Они общаются по типизированным
