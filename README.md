...
Из этого следует одно: локально проект слушает все интерфейсы, чтобы открываться с другой машины,
и до вашей регистрации владельцем станет тот, кто зарегистрируется раньше. В своей сети это не
важно, в чужой — поставьте `GATEWAY_BIND_HOST=127.0.0.1` или зарегистрируйтесь сразу.
